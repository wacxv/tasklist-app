...
namespace task_manager_api.Migrations
{
    ...
    [Migration("20260917160000_AddUsername")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.Models.TaskItem", b =>
                {
                    b.HasOne("TaskManager.Models.User", "User").WithMany("Tasks")
            ...
            modelBuilder.Entity("TaskManager.Models.TaskImage", b =>
                {
                    b.HasOne("TaskManager.Models.TaskItem", "TaskItem").WithMany("Images")
                        .HasForeignKey("TaskItemId").OnDelete(DeleteBehavior.Cascade).IsRequired();
