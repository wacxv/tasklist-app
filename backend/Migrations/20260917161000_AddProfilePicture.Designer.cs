...
namespace task_manager_api.Migrations
{
    ...
    [Migration("20260917161000_AddProfilePicture")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.Models.TaskItem", b =>
            {
                ...
                b.HasKey("Id"); b.HasIndex("UserId"); b.ToTable("Tasks");
            });
            ...
            modelBuilder.Entity("TaskManager.Models.TaskImage", b =>
            {
                ...
                b.HasKey("Id"); b.HasIndex("TaskItemId"); b.ToTable("TaskImages");
            });
            ...
            modelBuilder.Entity("TaskManager.Models.User", b =>
            {
                ...
                b.Property<string>("ProfilePictureContentType").HasColumnType("text");
                b.Property<byte[]>("ProfilePictureData").HasColumnType("bytea");
            ...
            modelBuilder.Entity("TaskManager.Models.TaskItem", b =>
            {
                b.HasOne("TaskManager.Models.User", "User").WithMany("Tasks").HasForeignKey("UserId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                b.Navigation("User");
            });
            modelBuilder.Entity("TaskManager.Models.TaskImage", b =>
            {
                b.HasOne("TaskManager.Models.TaskItem", "TaskItem").WithMany("Images").HasForeignKey("TaskItemId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                b.Navigation("TaskItem");
            });
            modelBuilder.Entity("TaskManager.Models.User", b => b.Navigation("Tasks"));
